...
export class PremiumsDeposited extends ethereum.Event {
  get params(): PremiumsDeposited__Params {
    return new PremiumsDeposited__Params(this);
  }
}

export class PremiumsDeposited__Params {
  _event: PremiumsDeposited;

  constructor(event: PremiumsDeposited) {
    this._event = event;
  }
...
export class UnderwriterVault extends ethereum.SmartContract {
  static bind(address: Address): UnderwriterVault {
    return new UnderwriterVault("UnderwriterVault", address);
  }
  ...
  PREMIUM_DEPOSITOR_ROLE(): Bytes {
    let result = super.call(
      "PREMIUM_DEPOSITOR_ROLE",
      "PREMIUM_DEPOSITOR_ROLE():(bytes32)",
      [],
    );
  ...
  try_PREMIUM_DEPOSITOR_ROLE(): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "PREMIUM_DEPOSITOR_ROLE",
      "PREMIUM_DEPOSITOR_ROLE():(bytes32)",
      [],
...
export class DepositPremiumsCall extends ethereum.Call {
  get inputs(): DepositPremiumsCall__Inputs {
    return new DepositPremiumsCall__Inputs(this);
  }

  get outputs(): DepositPremiumsCall__Outputs {
    return new DepositPremiumsCall__Outputs(this);
  }
}

export class DepositPremiumsCall__Inputs {
  _call: DepositPremiumsCall;

  constructor(call: DepositPremiumsCall) {
    this._call = call;
  }
...
export class DepositPremiumsCall__Outputs {
  _call: DepositPremiumsCall;
